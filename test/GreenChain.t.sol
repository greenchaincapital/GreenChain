...
import "../src/GreenChain.sol";

contract ERC20Test is Test {
  event Transfer(address indexed from, address indexed to, uint256 value);
  event Approval(address indexed owner, address indexed spender, uint256 value);

  GreenChain private erc20;
  ...
  function setUp() public {
    vm.startPrank(owner);
    erc20 = new GreenChain(2000000000000000000000000);
    erc20.transfer(userOne, 1000);
    erc20.transfer(userTwo, 1000);
    vm.stopPrank();
  }

  function testName() public {
    assertEq(erc20.name(), "GreenChain");
  }

  function testSymbol() public {
    assertEq(erc20.symbol(), "GREEN");
  }

  function testTotalSupply() public {
    assertEq(erc20.totalSupply(), 2000000000000000000000000);
  }
  ...
  function testMintToWithSuccess() public {
    vm.prank(owner);
    vm.expectEmit(true, true, true, true);
    emit Transfer(owner, userThree, 1000);
    erc20.transfer(userThree, 1000);
